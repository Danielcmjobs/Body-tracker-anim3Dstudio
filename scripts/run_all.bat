...
start "Backend Futbol" cmd /k "cd /d %PROJECT_ROOT%\modules\futbol\backend && set CORS_ORIGINS=https://localhost:8443,https://127.0.0.1:8443,http://localhost:8080,http://127.0.0.1:8080 && "%VENV_PYTHON%" app.py"
